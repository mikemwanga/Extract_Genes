...
hits_data = pd.read_table("./Results/hits.txt", sep = "\t", usecols=[0,1,2], names = ["ID", "start","stop"])
...
hits.to_csv("./Results/sequence_coordinates.txt", sep = "\t", header=False, index=False)
